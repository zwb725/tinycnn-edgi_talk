...
const cy_stc_mpc_regions_t M33_mpc_regions[] =
{
    ...
    {
        .base = (MPC_Type*)SMIF1_CORE_AXI_MPC0,
        .offset = 0x00000000,
        .size = 0x00200000,
    },
    {
...
const mtb_srf_memory_protection_s_t mtb_srf_memory_protection_s[] =
{
    ...
    {
        .ranges = smif_1_mpc_0_srf_protection_range_s,
        .size = 6U,
    },
    {
...
const mtb_srf_protection_range_s_t smif_1_mpc_0_srf_protection_range_s[smif_1_mpc_0_REGION_COUNT] =
{
    {
        .start = (void *) 0x64000000 ,
        .length = 0x200000U,
        .is_secure = false,
    },
    {
        .start = (void *) 0x64200000 ,
        .length = 0x200000U,
        .is_secure = false,
    },
    {
        .start = (void *) 0x64400000 ,
        .length = 0xC00000U,
        .is_secure = false,
    },
    {
