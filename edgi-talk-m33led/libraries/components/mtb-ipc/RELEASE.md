...
* Enabled mixed RTOS and non-RTOS pairing between client and receiver
* Added reinit_hw API for to handle re-initializations after the IPC hardware is reset
#### v1.0.0
