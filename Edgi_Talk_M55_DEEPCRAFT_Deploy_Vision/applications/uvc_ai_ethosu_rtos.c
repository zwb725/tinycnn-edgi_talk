...
int ethosu_semaphore_give(void *sem)
{
    ...
    {
        /*
         * Driver bookkeeping may occasionally "over-give" the global semaphore.
         * Keep behavior compatible with the original RTOS wrappers and do not
         * fail hard on a saturated counter.
         */
        return 0;
    }
