...
#define RT_CHERRYUSB_HOST_VIDEO
...
/* TinyCNN ExecuTorch board-test */
#define USE_EXECUTORCH_TINYCNN
#define RT_AI_USE_EXECUTORCH
#define RT_AI_EXECUTORCH_MODEL_TINYCNN
#define RT_AI_EXECUTORCH_LOAD_EMBEDDED
#define RT_AI_EXECUTORCH_RUNTIME_READY
#define RT_AI_EXECUTORCH_DEBUG_LOG 0
#define RT_AI_EXECUTORCH_METHOD_POOL_SIZE 524288
#define RT_AI_EXECUTORCH_TEMP_POOL_SIZE 524288
#define RT_AI_EXECUTORCH_MAX_PLANNED_BUFFERS 8
#define RT_AI_EXECUTORCH_MAX_IO_TENSORS 4
#define RT_AI_EXECUTORCH_ETHOSU_IRQ_PRIORITY 5
#define RT_AI_EXECUTORCH_ETHOSU_WAIT_TIMEOUT_MS 5000
#define RT_AI_EXECUTORCH_ETHOSU_CACHE_RANGE 1
#define RT_AI_EXECUTORCH_ETHOSU_CACHE_LINE_SIZE 32
/* end of TinyCNN ExecuTorch board-test */
